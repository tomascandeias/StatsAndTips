...
public class Player extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView textViewGR = (TextView) v.findViewById(R.id.textViewGRVal);
        textViewGR.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (getFragmentManager() != null) {
                    getFragmentManager().beginTransaction().replace(R.id.fl_navbar, new PlayerPage()).commit();
                }
            }
        });
